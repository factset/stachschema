...
DurationArray = _reflection.GeneratedProtocolMessageType('DurationArray', (_message.Message,), dict(
...
TimestampArray = _reflection.GeneratedProtocolMessageType('TimestampArray', (_message.Message,), dict(
