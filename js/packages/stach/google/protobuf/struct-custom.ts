...
export const Value = {
  ...
  fromJSON(object: any): Value {
    ...
    if (object === undefined || object === null) {
      ...
      message.listValue = ListValue.fromJSON(object);
    } else if (typeof object === "object") {
      message.structValue = Struct.fromJSON(object);
    }
    return message;
  },
  ...
  toJSON(message: Value): unknown {
    if (message.nullValue !== undefined && message.nullValue === NullValue.NULL_VALUE) return null;
    if (message.numberValue !== undefined) return message.numberValue;
    if (message.stringValue !== undefined) return message.stringValue;
    if (message.boolValue !== undefined) return message.boolValue;
    if (message.structValue !== undefined) return Struct.toJSON(message.structValue);
    if (message.listValue !== undefined) return ListValue.toJSON(message.listValue);
    return undefined;
  },
};
...
export const ListValue = {
  ...
  fromJSON(object: any): ListValue {
    ...
    if (Array.isArray(object)) {
      for (const e of object as Array<any>) {
  ...
  toJSON(message: ListValue): unknown {
    if (message.values) {
      return message.values.map(e => e ? Value.toJSON(e) : undefined);
    } else {
      return [];
    }
  },
